...
public class NetworkSetup : MonoBehaviour
{
    ...
    //а а а а string[] args = System.Environment.GetCommandLineArgs();
    //        for (int i = 0; i < args.Length; i++)
    //        {
    //            if (args[i] == "--server")
    //            {
    //а а а а а а а а // --server found, this should be a server application
    //а а а а а а а а isServer = true;
    //            }
    //            else if (args[i] == "--code")
    //            {
